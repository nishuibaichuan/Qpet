	...
	<body>
		<div class="admin-main">
			<blockquote class="layui-elem-quote">
				<p>本项目是Q宠网，实现对所有宠物的一系列规则操作.</p>
				Q宠网后台访问地址：
				<a href="http://localhost:8080/Qpet/admin/index" target="_blank">http://localhost:8080/Qpet/admin/index</a>
				<p></p>
				Q宠网前台访问地址：
				<a href="http://localhost:8080/Qpet/index" target="_blank">http://localhost:8080/Qpet/index</a>
				<p>项目地址：
